...
#include "../libvisplaygui/mpvwidget.h"
...
QT_MOC_LITERAL(5, 49, 7), // "swapped"
QT_MOC_LITERAL(6, 57, 13), // "on_mpv_events"
QT_MOC_LITERAL(7, 71, 11) // "maybeUpdate"

    },
    "MpvWidget\0durationChanged\0\0value\0"
    "positionChanged\0swapped\0on_mpv_events\0"
    "maybeUpdate"
};
...
void MpvWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        MpvWidget *_t = static_cast<MpvWidget *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->durationChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->positionChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 2: _t->swapped(); break;
        case 3: _t->on_mpv_events(); break;
        case 4: _t->maybeUpdate(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            typedef void (MpvWidget::*_t)(int );
...
const QMetaObject MpvWidget::staticMetaObject = {
    { &QOpenGLWidget::staticMetaObject, qt_meta_stringdata_MpvWidget.data,
      qt_meta_data_MpvWidget,  qt_static_metacall, nullptr, nullptr}
};
